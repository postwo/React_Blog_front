...
export default function Authentication() {
  ...
  const SignInCard = () => {
    ...
    const signInResponse = (
      responseBody: SignInResponseDto | ResponsDto | null
    ) => {
      if (!responseBody) {
        alert('네트워크 이상입니다.');
        return;
  ...
  const SignUpCard = () => {
    ...
    const signUpResponse = (
      responseBody: SignUpResponseDto | ResponsDto | null
    ) => {
      if (!responseBody) {
        alert('네트워크 이상입니다.');
        return;
    ...
    const onPasswordCheckChangeHanlder = (
            ...
            {page === 1 && (
              <>
                ...
                <InputBox
                  ...
                  value={passwordCheck}
                  onChange={onPasswordCheckChangeHanlder}
